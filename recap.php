                    ...
                    foreach($_SESSION['products'] as $index => $product){
                        ...
                        // On parcourt ici le tableau products et on ressort $index et $product pour en manipuler facilement les données.
                            ...
                            echo "<tr>",
                                ...
                                "<input type='hidden' name='productIndex' value='$index'>", // Dans $_POST ça prendra la forme de 'productIndex'=> 0, 1, 2 etc selon le produit concerné par la ligne. L'index change au fur et à mesure du foreach.
                                "</form></td>",                                
                                "</tr>";
